  ...
  public function antiTP(PlayerCommandPreprocessEvent $ev){
    ...
    if($p->isOp() or $p->hasPermission("pocketmine.command.teleport")){
      ...
      if(isset($this->tper[strtolower($p->getName())])){
        if($command == "/sethome" || $command == "./sethome" || $command == "/god" || $command == "./god" || $command == "/gamemode" || $command == "./gamemode" || $command == "/gma" || $command == "./gma" || $command == "/creative" || $command == "./creative" || $command == "/survival" || $command == "./survival" || $command == "/adventure" || $command == "./adventure" || $command == "./gmc" || $command == "/gmc" || $command == "./gms" || $command == "./gms" || $command == "/tp" || $command == "./tp" || $command == "/tpyes" || $command == "./tpyes" || $command == "/tpa" || $command == "./tpa" || $command == "/tpno" || $command == "./tpno" || $command == "/spectator" || $command == "./spectator" || $command == "/svon" || $command == "./svon" || $command == "./svoff" $command == "/sv" || $command == "./sv"){
